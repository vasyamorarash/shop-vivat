...
class Evopin_Fancypopup_Block_Fancypopup extends Mage_Core_Block_Template {

	public $fancypopupvar;
	private $image;
	private $url = '';
	...
	public function __construct() {
		...
		if (!$this->helper('fancypopup')->getIsEnabled()) {
			return;
		};

		$magento_now_date = $this->magentoNowDate();
				
		$this->fancypopupvar = Mage :: getModel('fancypopup/fancypopup')
			->getCollection()
		...
		foreach ($this->fancypopupvar as $vars) {
